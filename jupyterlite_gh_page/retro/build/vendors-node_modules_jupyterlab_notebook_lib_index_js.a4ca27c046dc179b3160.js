...
/* harmony import */ var _lumino_domutils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @lumino/domutils */ 69656);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! react */ 96927);
...
/* harmony import */ var _jupyterlab_shared_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @jupyterlab/shared-models */ 49634);
/* harmony import */ var _lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lumino/algorithm */ 79028);
...
class CellList {
    ...
    constructor(modelDB, factory, model) {
         ...
         */
        this._mutex = _jupyterlab_shared_models__WEBPACK_IMPORTED_MODULE_3__.createMutex();
    ...
    iter() {
        const arr = [];
        for (const id of (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.toArray)(this._cellOrder)) {
            arr.push(this._cellMap.get(id));
        }
        return new _lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.ArrayIterator(arr);
    }
    /**
     ...
     */
    removeValue(cell) {
        const index = _lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.ArrayExt.findFirstIndex((0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.toArray)(this._cellOrder), id => this._cellMap.get(id) === cell);
        this.remove(index);
        return index;
    }
    /**
     ...
     */
    pushAll(cells) {
        const newValues = (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.toArray)(cells);
        (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.each)(newValues, cell => {
            // Set the internal data structures.
            this._cellMap.set(cell.id, cell);
    ...
    _onOrderChanged(order, change) {
        if (change.type === 'add' || change.type === 'set') {
            (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.each)(change.newValues, id => {
        ...
        (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.each)(change.oldValues, id => {
...
/* harmony import */ var _jupyterlab_shared_models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @jupyterlab/shared-models */ 62055);
...
class NotebookModel {
    ...
    constructor(options = {}) {
         ...
         */
        this.sharedModel = _jupyterlab_shared_models__WEBPACK_IMPORTED_MODULE_7__.YNotebook.create();
        this._dirty = false;
        ...
        this._trans = (options.translator || _jupyterlab_translation__WEBPACK_IMPORTED_MODULE_4__.nullTranslator).load('jupyterlab');
...
(function (NotebookModel) {
    ...
    class ContentFactory {
        ...
        createCodeCell(options) {
            ...
            if (this.modelDB) {
                if (!options.id) {
                    options.id = _lumino_coreutils__WEBPACK_IMPORTED_MODULE_5__.UUID.uuid4();
                }
...
/* harmony import */ var _lumino_virtualdom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @lumino/virtualdom */ 52522);
...
/* harmony import */ var _lumino_widgets__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @lumino/widgets */ 77031);
...
/* harmony import */ var _lumino_coreutils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @lumino/coreutils */ 66065);
...
/* harmony import */ var _lumino_domutils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @lumino/domutils */ 69656);
...
/* harmony import */ var _lumino_dragdrop__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @lumino/dragdrop */ 66148);
...
/* harmony import */ var _lumino_virtualdom__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @lumino/virtualdom */ 52522);
...
/* harmony import */ var _lumino_widgets__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @lumino/widgets */ 77031);
...
//# sourceMappingURL=vendors-node_modules_jupyterlab_notebook_lib_index_js.a4ca27c046dc179b3160.js.map