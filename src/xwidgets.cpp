...
void register_widget_impl(sol::state_view  & lua, const std::string widget_name, extend_f && extend)
{
    ...
    sol::usertype<xwidgets_type> xwidgtes_lua_type = detail_table.new_usertype<xwidgets_type>(
        widget_name,
        // 1 constructors
        sol::constructors<xwidgets_type()>()
    );
    // typical member function that returns a variable
    xwidgtes_lua_type["display"] = &xwidgets_type::display;
    xwidgtes_lua_type["id"] = &xwidgets_type::id;

    xwidgtes_lua_type[sol::meta_function::to_string] = [widget_name](xwidgets_type & ){
        return widget_name;
    };
...
void register_xwidgets_impl(sol::state_view  & lua)
{
...

    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xbutton",[](auto && xwidgtes_lua_type){
            ...
            xwidgtes_lua_type["on_click"] = [](xwidgets_type & widget, sol::protected_function function){
...

    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xslider",[](auto && xwidgtes_lua_type){
...

    {
        ...
        // typical member function that returns a variable
        xwidgtes_lua_type["display"] = &xwidgets_type::display;
        xwidgtes_lua_type["capture"] = &xwidgets_type::capture;
        xwidgtes_lua_type["release"] = &xwidgets_type::release;
        xwidgtes_lua_type["captured"] = [](xwidgets_type & widget, sol::protected_function function){
            widget.capture();
            auto res = function.call();
            if (!res.valid())
            {
...

    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xhbox",[](auto && xwidgtes_lua_type){
            xwidgtes_lua_type["_add"] = [](xwidgets_type & widget, xeus::xguid id){
                widget.add(id);
            };
        });
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xvbox",[](auto && xwidgtes_lua_type){
...

    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xaccordion",[](auto && xwidgtes_lua_type){

            xwidgtes_lua_type["_add"] = [](xwidgets_type & widget, xeus::xguid id){
                widget.add(id);
            };

            xwidgtes_lua_type["set_title"] = [](xwidgets_type & widget, std::size_t i, std::string title){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xaudio",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xcheckbox",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xcolor_picker",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xcontroller",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xdropdown",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xhtml",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "ximage",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xlabel",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xnumeral",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xpassword",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xplay",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xprogress",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xselectionslider",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xtab",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xtext",[](auto && xwidgtes_lua_type){
            ...
            xwidgtes_lua_type["on_submit"] = [](xwidgets_type & widget, sol::protected_function function){
                auto callback = [function]() {
                    auto res = function.call();
                    if (!res.valid())
                    {
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xtextarea",[](auto && xwidgtes_lua_type){
...

    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xtogglebutton",[](auto && xwidgtes_lua_type){
            XLUA_ADD_PROPERTY(xwidgtes_lua_type, bool, value);
            XLUA_ADD_PROPERTY(xwidgtes_lua_type, bool, disabled);
            XLUA_ADD_PROPERTY(xwidgtes_lua_type, std::string, tooltip);
            XLUA_ADD_PROPERTY(xwidgtes_lua_type, std::string, icon);
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xtogglebuttons",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xvideo",[](auto && xwidgtes_lua_type){
    ...
    }
    {
        ...
        register_widget_impl<xwidgets_type>(lua, "xvalid",[](auto && xwidgtes_lua_type){
